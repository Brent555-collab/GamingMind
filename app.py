        ...
        with col_rec_right:
            if lang == "en":
                ...
                <div class="real-world-card">
                    <h4 style="color: #27AE60; margin-top:0;">15-Minute "Green Exercise"</h4>
                ...
                <div class="real-world-card">
                    <h4 style="color: #27AE60; margin-top:0;">Offline "Face-to-Face" Socializing</h4>
                    <p style="margin-bottom:8px; font-size:14px; line-height:1.5;">
                ...
                <div class="real-world-card">
                    <h4 style="color: #27AE60; margin-top:0;">Active Exercise & Stretching</h4>
                    <p style="margin-bottom:8px; font-size:14px; line-height:1.5;">
                ...
                st.markdown("""
                <div class="real-world-card">
                    <h4 style="color: #27AE60; margin-top:0;">15分钟“绿色森林浴” (Green Exercise)</h4>
                    <p style="margin-bottom:8px; font-size:14px; line-height:1.5;">
                        <b>科学原理：</b> 去公园散步15分钟。步行时的双侧交替运动能直接降低大脑杏仁核的活跃度，自然烧掉压力。
                    </p>
                </div>
                <div class="real-world-card">
                    <h4 style="color: #27AE60; margin-top:0;">线下“面对面”茶话会 (Real Connection)</h4>
                    <p style="margin-bottom:8px; font-size:14px; line-height:1.5;">
                        <b>科学原理：</b> 约一位好友线下聚会。面部表情的实时互动能刺激催产素的分泌，是天然的焦虑解药。
                    </p>
                </div>
                <div class="real-world-card">
                    <h4 style="color: #27AE60; margin-top:0;">暴汗运动与拉伸 (Endorphin Release)</h4>
                    <p style="margin-bottom:8px; font-size:14px; line-height:1.5;">
